...
class MultiComparatorApp:
    ...
    def setup_money_tab(self):
        ...
        frame_list = tk.LabelFrame(self.tab_money, text=" 3. 目前投資組合配置 (雙擊金額可原地直接修改) ")
    ...
    def setup_pct_tab(self):
        ...
        frame_list = tk.LabelFrame(self.tab_pct, text=" 3. 目前投資組合權重配置 (雙擊比例可原地直接修改，加總需為100%) ")
        frame_list.pack(pady=5, fill="both", expand=True, padx=10)
